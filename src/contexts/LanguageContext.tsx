...
const translations: Record<Language, Record<string, string>> = {
  it: {
    ...
    "contact.email": "Email",
    "contact.emailPlaceholder": "mario.rossi@azienda.it",
    "contact.phone": "Telefono",
    "contact.phonePlaceholder": "+39 123 456 7890",
    "contact.service": "Servizio richiesto",
    "contact.servicePlaceholder": "es. Consulenza contrattuale",
    "contact.message": "Messaggio",
    "contact.messagePlaceholder": "Descrivi brevemente la tua richiesta...",
    "contact.submit": "Invia Richiesta",
    "contact.sending": "Invio in corso...",
    "contact.successTitle": "Richiesta inviata!",
    "contact.successMessage": "Grazie per averci contattato. Ti risponderemo entro 24 ore.",
    "contact.errorTitle": "Errore",
    "contact.errorMessage": "Si è verificato un errore. Riprova più tardi.",
  ...
  en: {
    ...
    "contact.email": "Email",
    "contact.emailPlaceholder": "john.smith@company.com",
    "contact.phone": "Phone",
    "contact.phonePlaceholder": "+1 123 456 7890",
    "contact.service": "Service requested",
    "contact.servicePlaceholder": "e.g. Contract consulting",
    "contact.message": "Message",
    "contact.messagePlaceholder": "Briefly describe your request...",
    "contact.submit": "Send Request",
    "contact.sending": "Sending...",
    "contact.successTitle": "Request sent!",
    "contact.successMessage": "Thank you for contacting us. We'll respond within 24 hours.",
